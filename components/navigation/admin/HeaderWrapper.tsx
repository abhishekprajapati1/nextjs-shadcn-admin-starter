...
const HeaderWrapper: React.FC<HeaderProps> = ({ children, title, tagline }) => {
  return (
    <header className="flex h-16 px-6 shrink-0 bg-white items-center gap-2 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12">
