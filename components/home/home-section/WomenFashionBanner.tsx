  ...
  return (
    <Card className="w-full bg-white border-none shadow-none">
      <div className="bg-gray-200 py-6">
        <div className="text-lg md:text-xl text-black font-normal tracking-wider pt-2 text-center">
        ...
        <div className="relative">
          ...
          <div className="py-6 flex justify-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            <div className="relative text-center">
              <p className="px-2 py-2 text-gray-600 uppercase text-sm sm:text-lg md:text-lg tracking-widest">
                save up to 30% off
              </p>
              <h2 className="text-lg sm:text-2xl md:text-3xl lg:text-7xl font-bold tracking-widest">
