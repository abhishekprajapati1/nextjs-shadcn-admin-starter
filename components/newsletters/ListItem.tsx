...
import { setData } from "@/store/newsletters/form.slice";
import { setItemId } from "@/store/newsletters/form.slice";
import { setItemToDelete } from "@/store/newsletters/data.slice";
import { z } from "zod";
import { formSchema } from "@/lib/validations/admin/newsletters.validation";
import dayjs from "@/lib/dayjs";

export interface INewsletter extends IRecordMeta, z.infer<typeof formSchema> {}
