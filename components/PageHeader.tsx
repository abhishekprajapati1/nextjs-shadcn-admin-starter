...
const PageHeader: React.FC<PageHeaderProps> = ({ children, title = "Page Title", tagline, className = "" }) => {
    return (
        <div className={`flex w-full px-4 lg:px-10 justify-between items-center gap-4 h-16  ${className || ""}`}>
            <div className="">
